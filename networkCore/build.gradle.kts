...
import com.faaadi.apps.kotlindsl.config.BuildConfigType
import com.faaadi.apps.kotlindsl.config.BuildConfigFields
import com.faaadi.apps.kotlindsl.config.BuildConfigValues
